      ...
      <div className="card">
        ...
        <div className="setting-row">
          <div>
            ...
            <span className="muted"> — {contestOver ? 'Closed' : 'Open'}</span>
          </div>
          <button className="btn small" onClick={() => setContestOver(!contestOver)}>
            {contestOver ? 'Reopen' : 'Close'}
          </button>
        </div>
        <div className="setting-row">
          <div>
            <strong>Event status</strong>
            <span className="muted"> — {eventsOver ? 'Over' : 'Ongoing'}</span>
          </div>
          <button className="btn small" onClick={() => setEventsOver(!eventsOver)}>
            {eventsOver ? 'Mark ongoing' : 'Mark over'}
          </button>
        </div>
